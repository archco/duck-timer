...
var DuckTimer = function () {
  function DuckTimer() {
    ...
    this._clock = new _timeClock2.default();
  ...
  _createClass(DuckTimer, [{
    ...
    value: function _startTick() {
      this._tickIntevalId = setInterval(this._tickProcess.bind(this), this.option.tick);
    }
  }, {
    key: '_clearTick',
    value: function _clearTick() {
      clearInterval(this._tickIntevalId);
      this._tickIntevalId = null;
    }
  }, {
    key: '_hasTick',
    value: function _hasTick() {
      return this._tickIntevalId != null;
    }
  }, {
    key: '_onDelayTimeout',
    value: function _onDelayTimeout() {
    ...
    key: '_prepareCountdown',
    value: function _prepareCountdown() {
      if (!this._clock.distance) return;
      var remaindler = this._clock.distance.time % this.option.interval || 0;
...
var TimeClock = function () {
  ...
  _createClass(TimeClock, [{
    ...
    key: 'remain',
    get: function get() {
      return this.distance ? new TimeClock(this.distance.time - this.time) : this.timeout ? new TimeClock(this.timeout.time - this.time) : undefined;
    }
  }, {
    key: 'timeout',
    get: function get() {
